...
/>
      <div className="mb-3">
        <label htmlFor="exampleInputName1" className='fw-bolder'>الإسم:</label>
      ...
      <div className="mb-3">
        <label htmlFor="exampleInputEmail1" className='fw-bolder'>الجيميل:</label>
      ...
      <div className="mb-3">
        <label htmlFor="exampleInputmessage1" className='fw-bolder'>إجعل رسالتك بناءة:</label>
      ...
      <button disabled={!(formik.isValid && formik.dirty)} type="submit" className="text-uppercase  fw-bolder">إرسال</button>
