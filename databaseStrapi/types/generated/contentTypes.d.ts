...
export interface ApiClinicClinic extends Schema.CollectionType {
  ...
  attributes: {
    clinicName: Attribute.String & Attribute.Required & Attribute.Unique;
    doctorName: Attribute.Relation<
      'api::clinic.clinic',
      'oneToMany',
      'api::doctor.doctor'
    >;
...
export interface ApiMedicalAnalysisLaboratoryMedicalAnalysisLaboratory
  extends Schema.CollectionType {
  collectionName: 'medical_analysis_laboratories';
  info: {
    singularName: 'medical-analysis-laboratory';
    pluralName: 'medical-analysis-laboratories';
    displayName: 'Medical analysis laboratory';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    LabName: Attribute.String & Attribute.Required;
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::medical-analysis-laboratory.medical-analysis-laboratory',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiRadiologyLaboratorieRadiologyLaboratorie
  ...
  info: {
    singularName: 'radiology-laboratorie';
    pluralName: 'radiology-laboratories';
    displayName: 'Radiology laboratorie';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::radiology-laboratorie.radiology-laboratorie',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
